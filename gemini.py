...
async def on_ready():
    ...
    print(banner_two)
    print(f"                                               {lred}Dibbos Lair Started.")
    print(f"                                        {lgreen}Author: {lcyan}Dibbo")
...
async def avatar(ctx, *, member: discord.Member = None):
    ...
    embed.set_footer(text=f"Dibbos Lair | Dibbo")
    await ctx.send(embed=embed)

@client.event
async def on_command_error(ctx, error):
    if isinstance(error, commands.CommandNotFound):
        embed = discord.Embed(title=f"You are using the wrong command.", color=discord.Color.from_rgb(255, 153, 0))
        await ctx.send(embed=embed)
    ...
    if isinstance(error, commands.errors.MissingRequiredArgument):
        embed = discord.Embed(title="Please provide an argument! You can't leave a field blank, please use $help for more context.",color=discord.Color.from_rgb(255, 153, 0))
        await ctx.send(embed=embed)
...
async def proxy(ctx):
    ...
    embed.set_footer(text="Dibbos Lair | Dibbo")
    await ctx.send(embed=embed)
...
async def invite(ctx):
    ...
    embed.add_field(name='**Invite link**:', value='[Your Invite Link Here]', inline=True)
    embed.set_footer(text="Dibbos Lair | Dibbo")
    await ctx.send(embed=embed)   
     ...
     await ctx.send("invalid ip!")
       ...
       async with aiohttp.ClientSession() as session:
                async with session.get(f"https://api.viewdns.info/portscan/?host={arg1}&apikey=629e5c64f2ca88c1652e746b083af35a06cc57bb&output=json") as r:
                       if r.status == 200:
                        text = await r.text()
                        embed1 = discord.Embed(title=(f'Results for {arg1}'), description=(text), color=discord.Color.from_rgb(0, 191, 255))
...
async def storm(ctx, arg1, arg2):
    if arg1 == '1.1.1.1':
        ...
        embed.add_field(name=f'[**𝗣𝗢𝗪𝗘𝗥**]: ``Maximum``', value='**[𝗔𝗨𝗧𝗛𝗢𝗥]**: ``Dibbo``' , inline=False)
        embed.set_thumbnail(url='https://media.discordapp.net/attachments/964800182980059149/987727980367319110/9296f70fce1ae3f298e0d085c17f6a3f.gif')
        embed.set_footer(text="Dibbos Lair | Dibbo")
        embed.set_image(url=f'https://cdn.discordapp.com/attachments/984452619433050135/989905993116815360/rocket-silo.gif')
        t1 = threading.Thread(target=attack)
        t1.start()
...
async def emotialdamage(ctx, arg1, arg2):
    if arg1 == '1.1.1.1':
        ...
        embed = discord.Embed(title='>> ***ATTACK SENT SUCCESSFULLY*** <<',color=random.choice(colors) , timestamp= ctx.message.created_at)
        embed.add_field(name=f'[𝗧𝗔𝗥𝗚𝗘𝗧]: ``{arg1}``', inline=False, value=f'**[𝗣𝗥𝗢𝗧𝗢𝗖𝗢𝗟]**: ``{arg2}``')
        embed.add_field(name=f'[**𝗠𝗘𝗧𝗛𝗢𝗗**]: ``emotialdamage``', value='**[𝗧𝗜𝗠𝗘]**: ``60sec``', inline=False)
        embed.add_field(name=f'[**𝗣𝗢𝗪𝗘𝗥**]: ``Maximum``', value='**[𝗔𝗨𝗧𝗛𝗢𝗥]**: ``Dibbo``' , inline=False)
        embed.set_thumbnail(url='https://media.discordapp.net/attachments/964800182980059149/987727980367319110/9296f70fce1ae3f298e0d085c17f6a3f.gif')
        embed.set_footer(text="Dibbos Lair | Dibbo")
        embed.set_image(url=f'https://cdn.discordapp.com/attachments/984452619433050135/989905993116815360/rocket-silo.gif')
...
async def downshield(ctx, arg1, arg2):
    if arg1 == '1.1.1.1':
        ...
        embed = discord.Embed(title='>> ***ATTACK SENT SUCCESSFULLY*** <<',color=random.choice(colors) , timestamp= ctx.message.created_at)
        embed.add_field(name=f'[𝗧𝗔𝗥𝗚𝗘𝗧]: ``{arg1}``', inline=False, value=f'**[𝗣𝗥𝗢𝗧𝗢𝗖𝗢𝗟]**: ``{arg2}``')
        embed.add_field(name=f'[**𝗠𝗘𝗧𝗛𝗢𝗗**]: ``downshield``', value='**[𝗧𝗜𝗠𝗘]**: ``60``', inline=False)
        embed.add_field(name=f'[**𝗣𝗢𝗪𝗘𝗥**]: ``Maximum``', value='**[𝗔𝗨𝗧𝗛𝗢𝗥]**: ``Dibbo``' , inline=False)
        embed.set_thumbnail(url='https://media.discordapp.net/attachments/964800182980059149/987727980367319110/9296f70fce1ae3f298e0d085c17f6a3f.gif')
        embed.set_footer(text="Dibbos Lair | Dibbo")
        embed.set_image(url=f'https://cdn.discordapp.com/attachments/984452619433050135/989905993116815360/rocket-silo.gif')
...
async def resolve(ctx, arg1):
    ...
    if not json_object.get("online", False):
        ...
        embed.add_field(name="[𝗣𝗟𝗔𝗬𝗘𝗥𝗦]:", value=json_object["players"]["online"], inline=False)
        ...
        embed.set_thumbnail(url='https://media.giphy.com/media/3og0ILLVvPp8d64Jd6/giphy.gif')
...
async def iplookup(ctx, arg1):
    ...
    embed.add_field(name="Ip:", value=json_object.get("ip", "N/A"), inline=False)
    embed.add_field(name="Type:", value=json_object.get("type", "N/A"), inline=False)
    embed.add_field(name='Continent:', value=json_object.get("continent", "N/A"), inline=False)
    embed.add_field(name="Region:", value=json_object.get("region", "N/A"), inline=False)
    embed.add_field(name="Country:", value=json_object.get("country", "N/A"), inline=False)
    embed.add_field(name="City:", value=json_object.get("city", "N/A"), inline=False)
    embed.add_field(name="Latitude:", value=json_object.get("latitude", "N/A"), inline=False)
    embed.add_field(name="Longitude:", value=json_object.get("longitude", "N/A"), inline=False)
    embed.add_field(name="Timezone:", value=json_object.get("timezone_gmt", "N/A"), inline=False)
    embed.add_field(name="ISP:", value=json_object.get("isp", "N/A"), inline=False)
    embed.add_field(name="Org:", value=json_object.get("org", "N/A"), inline=False)
    embed.add_field(name="ASN:", value=json_object.get("asn", "N/A"), inline=False)
    embed.set_footer(text="Dibbos Lair | Dibbo")
    embed.set_image(url=f'https://cdn.discordapp.com/attachments/964800182980059149/988360082033082368/standard.gif')
    await ctx.send(embed=embed)
